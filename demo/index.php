...
<body <?= (isset($_COOKIE["darkmode"]) && $_COOKIE["darkmode"] == "on") ? 'data-theme="dark"' : ""; ?>>
    <div class="type-code">
        <div class="type-icon">
        <box-icon type='solid' name='copy-alt'></box-icon>
        </div>
        <div class="logo-text">
    <h1>Typing SVG</h1>
        </div>
    ...
    <div class="github">
        <!-- GitHub Sponsors -->
        <a class="github-button" href="https://github.com/mithlesharya" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-heart" data-size="large" aria-label="Sponsor @denvercoder1 on GitHub">Sponsor</a>
        <!-- View on GitHub -->
        <a class="github-button" href="https://github.com/themscool" data-color-scheme="no-preference: light; light: light; dark: dark;" data-size="large" aria-label="View denvercoder1/readme-typing-svg on GitHub">View on GitHub</a>
        <!-- GitHub Star -->
        <a class="github-button" href="https://github.com/Mithlesharya/Mastery-react" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star denvercoder1/readme-typing-svg on GitHub">Star</a>
    </div>
    ...
    <div class="output top-bottom-split">
        ...
        <div class="properties">
            ...
            <form class="parameters two-columns options">
                ...
                <input class="param jscolor jscolor-active" id="color" name="color" alt="Font color" data-jscolor="{ format: 'hexa' }" value="#8a43ff">
